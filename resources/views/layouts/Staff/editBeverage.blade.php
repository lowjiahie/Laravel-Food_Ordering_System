                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a type="button" id="popup" href="{{url('beverageEditForm/'. $value->id)}}" class="btn btn-success""><i class="fas fa-edit"></i></a>
                                                                    <a type="button" id="popup" class="btn btn-danger" href="editBeverage/destroy/{{$value->id}}"><i class="far fa-trash-alt"></i></a>
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                            @else
